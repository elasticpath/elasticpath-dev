    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { to: '/docs/api/application-keys/delete-key', from: '/docs/commerce-cloud/authentication/application-keys/delete-an-application-key'},
          ...
          { to: '/docs/api/application-keys/create-key', from: '/docs/commerce-cloud/authentication/application-keys/application-keys-cm'},
          ...
          { to: '/docs/api/application-keys/get-all-keys', from: '/docs/commerce-cloud/authentication/application-keys/get-an-application-key'},
          ...
          { to: '/docs/api/application-keys/update-key', from: '/docs/commerce-cloud/authentication/application-keys/update-an-application-key'},
          ...
          { to: '/docs/api/application-keys/create-key', from: '/docs/commerce-cloud/authentication/application-keys/create-an-application-key'},
