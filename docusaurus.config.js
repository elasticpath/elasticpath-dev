    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { to: '/docs/studio/developers/css-variables', from: '/docs/cx-studio/developers/custom-themes/css-variables'},
          ...
          { to: '/docs/studio/design/layouts/Header-and-Footer/Managing-Social-Links-in-your-Footer', from: '/docs/cx-studio/design/Header-and-Footer/Managing-Social-Links-in-your-Footer'},
          ...
          { to: '/docs/studio/design/layouts/Header-and-Footer/How-to-customize-header-color', from: '/docs/cx-studio/design/Header-and-Footer/How-to-customize-header-color'},
          { to: '/docs/studio/design/layouts/Header-and-Footer/Removing-the-Unstack-Branding-from-your-Footer', from: '/docs/cx-studio/design/Header-and-Footer/Removing-the-Unstack-Branding-from-your-Footer'},
          ...
          { to: '/docs/studio/design/layouts/Header-and-Footer/How-to-add-a-button-to-your-header', from: '/docs/cx-studio/design/Header-and-Footer/How-to-add-a-button-to-your-header'},
          ...
          { to: '/docs/studio/developers/tags/cart-and-drawer-soon', from: '/docs/cx-studio/developers/e-commerce/cart-and-drawer-soon'},
          { to: '/docs/studio/design/layouts/Header-and-Footer/Adding-&-Removing-Header-Dropdowns', from: '/docs/cx-studio/design/Header-and-Footer/Adding-&-Removing-Header-Dropdowns'},
          ...
          { to: '/docs/studio/developers/tags/header-and-footer', from: '/docs/cx-studio/developers/components/header-and-footer'},
          ...
          { to: '/docs/promotions-builder/promotions-builder-api/promotions-builder-management/get-a-promotions-builder-by-id', from: '/docs/commerce-cloud/rule-promotions/rule-promotions-api/rule-promotions-management/get-rule-promotions'},
          ...
          { to: '/docs/studio/design/layouts/Header-and-Footer/Header-Formatting-Options', from: '/docs/cx-studio/design/Header-and-Footer/Header-Formatting-Options'},
          ...
          { to: '/docs/studio/design/layouts/Header-and-Footer/How-to-make-my-header-transparent', from: '/docs/cx-studio/design/Header-and-Footer/How-to-make-my-header-transparent'},
          ...
          { to: '/docs/studio/developers/tags/product', from: '/docs/cx-studio/developers/e-commerce/product'},
          ...
          { to: '/docs/promotions-builder/promotions-builder-api/promotions-builder-management/delete-a-promotions-builder', from: '/docs/commerce-cloud/rule-promotions/rule-promotions-api/rule-promotions-management/delete-a-rule-promotion'},
          ...
          { to: '/docs/studio/developers/tags/generator', from: '/docs/cx-studio/developers/utility/generator'},
          { to: '/docs/studio/developers/tags/product-options', from: '/docs/cx-studio/developers/e-commerce/product-options'},
          ...
          { to: '/docs/studio/developers/tags/section', from: '/docs/cx-studio/developers/components/section'},
          ...
          { to: '/docs/studio/design/layouts/Header-and-Footer/Adjusting-the-Header-color-of-a-Landing-page', from: '/docs/cx-studio/design/Header-and-Footer/Adjusting-the-Header-color-of-a-Landing-page'},
          { to: '/docs/studio/Integrations/Stock-Media-Integrations', from: '/docs/cx-studio/Integrations/Stock-Media-Integrations'},
          { to: '/docs/studio/developers/tags/product-price', from: '/docs/cx-studio/developers/e-commerce/product-price'},
          ...
          { to: '/docs/studio/developers/tags/jsonparser', from: '/docs/cx-studio/developers/utility/jsonparser'},
          ...
          { to: '/docs/studio/design/layouts/Header-and-Footer/Adjusting-Header-&-Footer-Logo-Size', from: '/docs/cx-studio/design/Header-and-Footer/Adjusting-Header-&-Footer-Logo-Size'},
          ...
          { to: '/docs/promotions-builder/promotions-builder-codes/create-promotion-codes', from: '/docs/commerce-cloud/rule-promotions/rule-promotion-codes/create-rule-promotion-codes'},
          ...
          { to: '/docs/studio/developers/tags/product-inventory', from: '/docs/cx-studio/developers/e-commerce/product-inventory'},
          ...
          { to: '/guides/key-concepts/organizations/org-level-entities', from: '/docs/commerce-cloud/organizations/org-level-entities'},
          ...
          { to: '/docs/studio/design/layouts/Header-and-Footer/Adding-links-to-your-Header-&-Footer-Navigation', from: '/docs/cx-studio/design/Header-and-Footer/Adding-links-to-your-Header-&-Footer-Navigation'},
          ...
          { to: '/docs/api/carts/get-cart-items', from: '/docs/commerce-cloud/carts/cart-items/get-cart-items'},
          ...
          { to: '/docs/api/carts/get-order-items', from: '/docs/commerce-cloud/carts/cart-items/add-custom-item-to-cart'},
          ...
          { to: '/guides/How-To/organizations/create-pxm-org-entities', from: '/docs/commerce-cloud/organizations/org-level-pxm-entities/create-pxm-org-entities'},
          ...
          { to: '/docs/api/carts/get-an-order', from: '/docs/commerce-cloud/orders/orders-api/get-an-order'},
          ...
          { to: '/docs/promotions-builder/promotions-builder-api/action-limitations/action-limitations-overview', from: '/docs/commerce-cloud/rule-promotions/rule-promotions-api/action-limitations/action-limitations-overview'},
          ...
          { to: '/docs/api/carts/get-a-cart', from: '/docs/commerce-cloud/carts/cart-management/get-a-cart'},
          ...
          { to: '/docs/api/carts/manage-carts', from: '/docs/commerce-cloud/carts/cart-items/add-product-to-cart'},
          ...
          { to: '/docs/promotions-builder/promotions-builder-api/item-level-promotions/create-item-discount-with-condition', from: '/docs/commerce-cloud/rule-promotions/overview'},
          ...
          { to: '/docs/api/carts/get-order-items', from: '/docs/commerce-cloud/orders/orders-api/order-items'},
          ...
          { to: '/docs/api/carts/checkout', from: '/docs/commerce-cloud/checkout/account-checkout'},
          ...
          { to: '/guides/How-To/organizations/pxm-org-hierarchies', from: '/docs/commerce-cloud/organizations/org-level-pxm-entities/pxm-org-hierarchies'},
          ...
          { to: '/docs/api/pxm/catalog/get-by-context-product', from: '/docs/pxm/catalogs/shopper-catalog/get-a-product'},
          ...
          { to: '/docs/api/carts/orders', from: '/docs/commerce-cloud/orders/orders-api/orders-api-overview'},
          ...
          {to: '/guides/key-concepts/organizations/overview', from: `/docs/organizations/`},
          ...
          {to: '/guides/How-To/organizations/pxm-org-hierarchies', from: '/docs/organizations/org-level-pxm-entities/pxm-org-hierarchies'},
