    ...
    [
      '@docusaurus/plugin-client-redirects',
      {
        redirects: [
          ...
          { to: 'docs/api/carts/create-cart-payment-intent', from: '/docs/commerce-cloud/carts/cart-payment-intent/create-payment-intent-against-cart'},
          ...
          { to: '/docs/api/carts/get-carts', from: '/docs/commerce-cloud/carts/cart-management/get-all-carts'},
          ...
          { to: '/docs/api/carts/create-a-cart', from: '/docs/commerce-cloud/carts/cart-management/update-a-cart'},
          ...
          { to: '/docs/api/carts/create-a-cart', from: '/docs/commerce-cloud/carts/cart-management/cart-settings/update-cart-settings'},
          ...
          { to: '/docs/api/carts/get-carts', from: '/docs/commerce-cloud/carts/customer-cart-associations/get-customer-carts'},
