...
- Ensure that you have downloaded the latest Postman collection and environment from the following links:
    ...
    - [Collection](https://elasticpath.dev/static/postman/collection.json)
    - [Environment](https://elasticpath.dev/static/postman/environment.json)
...
1. Import the [Environment](https://elasticpath.dev/static/postman/environment.json) file.
