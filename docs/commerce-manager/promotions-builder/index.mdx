...
- [Shipping Discount](/docs/commerce-manager/promotions-builder/creating-a-promotion-in-promotions-builder#creating-a-shipping-promotion): Shipping discount applies to eligible cart shipping groups. The discount applies to shipping base price excluding tax and fees.
...
![Scenario 9](/assets/first-time-shopper.png)
