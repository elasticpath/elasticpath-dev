...
1. (Optional) In **Settings**, select the checkbox for **Use as the URL of entry record**. This option is shown only when you select **String** field.
     
        When this option is enabled, the value of this field will be used as the URL slug for entries created in the Custom API. This field must be a String, unique, and cannot allow null value.
