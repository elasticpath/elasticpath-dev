...
1. (Optional) In **Settings** section, set **Sort Order** of your field. Allows you to prioritize the order in which fields are presented in the User Interface. Fields with a higher value will appear first, it must be between 0 and 1000.
