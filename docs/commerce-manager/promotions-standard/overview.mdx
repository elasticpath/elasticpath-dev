...
- <Video
  mediaSrc="https://www.youtube.com/embed/MQTrLZp3cjI"
  mediaType="embed"
  title="Configuring a Promotion" />
- <Video
  mediaSrc="https://www.youtube.com/embed/fyQV8YWj4os"
  mediaType="embed"
  title="Configuring a Hierarchy-Based Promotion" />
- <Video
  mediaSrc="https://www.youtube.com/embed/x7TP4dsjNYs"
  mediaType="embed"
  title="Configuring an AND/OR Promotion Conditions" />
