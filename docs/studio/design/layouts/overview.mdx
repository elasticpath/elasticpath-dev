...
1. If required, create your own custom components, including banners, headers, footers, layouts or sections. See [Custom Components](/docs/studio/developers/components).
1. In the **Layouts** editor, create your new layout. You can create a layout from scratch, use a default layout or use a custom layout that you have created.
