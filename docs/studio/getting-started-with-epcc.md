...
1. Go to **SYSTEM** > **Application keys** to create your new API keys. See [Application keys](/docs/commerce-cloud/authentication/application-keys/application-keys-cm).
1. Log into Studio.
