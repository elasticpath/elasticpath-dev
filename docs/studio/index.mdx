...
Studio ships with **over 40 pre-built block components** that make it easy to build pages. Each of these can be customized with your own code and styles. You can also [build your own components](/docs/studio/developers/).
