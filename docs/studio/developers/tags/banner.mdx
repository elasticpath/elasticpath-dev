...
| properties | array/object | Optional | Define properties that content authors can configure within the page editor. For details see [custom properties](/docs/cx-studio/developers/features/properties). |
