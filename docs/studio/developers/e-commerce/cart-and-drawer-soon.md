...
| `className`    | `string`         | Optional | An optional CSS class that you can add to cart buttons. You can add any value you want, and specify in your stylesheet how you want the button to look. We've just defined a class for quantity-selector-decrement and increment in our own stylesheets for our components <ul><li>`quantity-selector-decrement` if you want shoppers to be able to decrement a product.</li><li>`quantity-selector-increment` if you want shoppers to be able to increment a product.</li></ul> |
