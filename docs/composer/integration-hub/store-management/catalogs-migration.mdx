...
| Brands and collections | - Products from a specific brand are grouped together and represented as a node in a hierarchy.
...
| Product custom fields | Product templates.  
...
For more information, see [Templates](/docs/api/flows/flows-service-introduction#templates-in-product-experience-manager). |
...
For more information, see [Product Variations](/docs/api/pxm/products/variations). |
