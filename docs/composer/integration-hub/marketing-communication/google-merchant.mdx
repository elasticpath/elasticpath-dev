...
- This integration has been deprecated as Google is now [urging customers to use the new Merchant API](https://ads-developers.googleblog.com/2024/07/announcing-merchant-api-beta-new.html).  Please use the new [Google Merchant Center integration](./google-merchant-center) instead of this integration as it provides several key features this integration does not.  This integration will no longer recieve updates or feature enhancements.
