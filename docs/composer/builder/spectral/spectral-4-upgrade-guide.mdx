...
Spectral 4.x introduces the ability to write [component-specific triggers](/docs/composer/builder/custom-components/writing-custom-components.mdx#writing-triggers).
...
Next, optionally write some [triggers](/docs/composer/builder/custom-components/writing-custom-components.mdx#writing-triggers) and add those triggers to your `component` definition:
