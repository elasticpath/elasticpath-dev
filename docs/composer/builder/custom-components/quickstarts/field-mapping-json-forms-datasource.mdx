...
You can initialize the data mapper data source project as you would [any other custom component](/docs/composer/builder/custom-components/writing-custom-components.mdx#initializing-a-new-component).
...
If you are integrating with a different CRM, you can use their respective NPM package or a [generic HTTP client](/docs/composer/builder/custom-components/writing-custom-components.mdx#using-the-built-in-createclient-http-client).
