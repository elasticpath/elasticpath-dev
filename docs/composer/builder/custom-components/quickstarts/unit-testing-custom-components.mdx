...
In the [Hello Composer](/docs/composer/builder/getting-started/first-custom-component/hello-prismatic.mdx) tutorial, you build a custom component that takes a first name and last name as inputs, and returns a message that greets the user.
...
In the [Wrap an API in a Component](/docs/composer/builder/custom-components/quickstarts/wrapping-an-api-in-a-component.mdx) tutorial, you build a custom component that wraps a mock API.
