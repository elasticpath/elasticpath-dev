...
In the [Hello Composer](getting-started/first-custom-component/hello-prismatic.mdx) tutorial, you build a custom component that takes a first name and last name as inputs, and returns a message that greets the user.
...
In the [Wrap an API in a Component](quickstarts/wrapping-an-api-in-a-component.mdx) tutorial, you build a custom component that wraps a mock API.
