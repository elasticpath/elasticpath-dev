...
In the [Hello Composer](/docs/composer/builder/getting-started/first-custom-component/hello-builder.mdx) tutorial, you build a custom component that takes a first name and last name as inputs, and returns a message that greets the user.
