...
## Input fields ([ValidateIntegrationSchemaInput!](/docs/composer/builder/api/schema/input_object/ValidateIntegrationSchemaInput.mdx))
...
## Return fields ([ValidateIntegrationSchemaPayload](/docs/composer/builder/api/schema/object/ValidateIntegrationSchemaPayload.mdx))
