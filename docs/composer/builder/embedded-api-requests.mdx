...
Full documentation on the API is available in the [API docs](/docs/composer/builder/api/api-overview.mdx), including several [example queries and mutations](/docs/composer/builder/api/using-prismatic-api.mdx).
