...
Generally, it's best to give your customers the ability to deploy instances themselves through the [integration marketplace](/docs/composer/builder/integration-marketplace.mdx).
...
When you are satisfied with an integration and have [published](/docs/composer/builder/integrations.mdx#publishing-an-integration) a version of it, you can create an instance of that integration for a customer.
...
The embedded marketplace shows only integrations that have been explicitly [added to marketplace](/docs/composer/builder/integration-marketplace.mdx/#preparing-an-integration-for-the-integration-marketplace).
...
To do that, you will need to create an unconfigured instance for a customer and elect to [show all instances](/docs/composer/builder/embedding-marketplace.mdx/#showing-all-instances-in-marketplace) to your customer.
