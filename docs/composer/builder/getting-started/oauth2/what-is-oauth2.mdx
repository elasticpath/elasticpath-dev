...
If you're [building a custom component](/docs/composer/builder/custom-components/writing-custom-components.mdx#writing-oauth-20-connections), you just need to provide Builder with the authorization and token URLs for the third-party app or service that you're integrating with.
