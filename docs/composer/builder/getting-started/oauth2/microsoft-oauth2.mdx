...
Many Microsoft apps (like [Teams](/docs/composer/builder/components/ms-teams.mdx), [Outlook](/docs/composer/builder/components/ms-outlook.mdx), [OneDrive](/docs/composer/builder/components/ms-onedrive.mdx), etc.) use OAuth 2.0 for authorization.
