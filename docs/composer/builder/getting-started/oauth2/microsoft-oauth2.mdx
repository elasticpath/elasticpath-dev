...
1. Select **Web** under **Platforms** and add the Builder OAuth 2.0 callback URL as the **Redirect URI**. The Builder OAuth 2.0 callback URL for the US commercial region is `https://oauth2.prismatic.io/callback`.
