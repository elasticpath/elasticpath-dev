...
Run `prism components:init hello-prismatic`. You can give your component a description of "My First Component", and for **Type of Connection** select **Basic Connection**.
...
This will create a new directory called `hello-prismatic` in your current directory.
...
Open the component directory that you just created in your code editor, and remove all files from the `hello-prismatic/src/` directory _except_ for `index.ts`.
