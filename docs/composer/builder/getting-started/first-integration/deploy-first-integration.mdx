...
Now that you've [built your first integration](/docs/composer/builder/getting-started/first-integration/build-first-integration.mdx), let's deploy the integration to a customer.
...
Learn more about your options [here](/docs/composer/builder/instances.mdx#options-for-deploying-instances).

## Create a customer

Your software company has [customers](/docs/composer/builder/customers.mdx).
...
In the next page you'll learn how to productize your integration and [prepare it for marketplace](/docs/composer/builder/getting-started/first-integration/prepare-for-marketplace.mdx).
