...
Make sure that you have created a Slack OAuth app and have access to a Slack workspace ([see docs](/docs/composer/builder/components/slack.mdx#slack-oauth-20)).
...
- Send your message to a different system, like [Microsoft Teams](/docs/composer/builder/components/ms-teams.mdx).
- Swap out the HTTP GET action for a different data source component (perhaps pull from an [SFTP](/docs/composer/builder/components/sftp.mdx) server)?
- Write your message out to a file in [Dropbox](/docs/composer/builder/components/dropbox.mdx) or [Amazon S3](/docs/composer/builder/components/aws-s3.mdx) instead of Slack.
