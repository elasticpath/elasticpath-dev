...
The best way to do that is with [branching](/docs/composer/builder/components/branch.mdx) logic - we'll detect what type of request we received, and follow a series of steps to process the request accordingly.
...
To run some "setup" logic when an instance of our integration is deployed, we'll use an [Instance Deploy](/docs/composer/builder/components/management-triggers.mdx#instance-deploy) trigger.
You can similarly use an [Instance Remove](/docs/composer/builder/components/management-triggers.mdx#instance-remove) trigger to run "teardown" logic when an instance is removed.
...
The GitHub component's [List Repos](/docs/composer/builder/components/github.mdx#list-repos) data source will allow us to create that dropdown menu.
...
To do that, we'll begin another flow with an [Instance Remove](/docs/composer/builder/components/management-triggers.mdx#instance-remove) trigger, which executes when someone deletes an instance.
...
We used Zendesk and GitHub for illustration purposes, but you can build similar integrations between your app and a [variety](/docs/composer/builder/components/component-catalog.mdx) of other third-party apps.
