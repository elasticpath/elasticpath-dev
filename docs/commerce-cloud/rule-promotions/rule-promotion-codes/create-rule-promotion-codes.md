...
| `codes[].user` | Optional | `string`  | Specifies the customer ID of the shopper who can use the code. For more information, see the [Create a customer](/docs/commerce-cloud/customer-management/customer-managment-api/create-a-customer) section. |
