...
Commerce supports many OpenID Connect compatible authentication providers. For more information, see [Requirements for Authentication Providers](/docs/commerce-cloud/authentication/single-sign-on/get-single-sign-on-customer-token#requirements-for-authentication-providers).
...
- [Security](/docs/commerce-cloud/authentication/security)
