...
<CardSection
id="re"
description="Learn how to get started with an Elastic Path storefront"
>
<Card
title="Creating a storefront"
to="/docs/developer-tools/composable-starter/storefront-starter"
description="Getting started with a storefront"
/>
</CardSection>
...
![composable-frontend-arch.png](/assets/composable-frontend-arch.png)
