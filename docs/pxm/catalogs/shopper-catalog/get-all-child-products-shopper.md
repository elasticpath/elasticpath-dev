...
|:--- |:--- |:--------------------------------------------------------------|:--- |
| `Eq` | Checks if the values of two operands are equal. If they are, the condition is true. | `name`, `sku`, `slug`, `mpn`, `upc_ean`, `product_types`      | `filter=eq(name,some-name)` |
| `In` | Checks if the values are included in the specified string. If they are, the condition is true. | `id`, `name`, `sku`, `slug`, `mpn`, `upc_ean`, `product_types` | `filter=in(id,some-id)` |
