...
| Name | <ul><li>**starts with**</li><li>**is**<li><li>**is like**</li>**ends with**</li><li>**list**</li></ul> | <ul><li>For **starts with**, **is**, **is like**, and **ends with**, type the value you want. You can use [supported characters](#supported-characters).</li><li>For **list**, specify a list of names. Only the products whose names you have specified are shown.</li></ul> |
...
| Slug | <ul><li>**starts with**</li><li>**is**</li><li>**is like**</li><li>**ends with**</li><li>**list**</li> | <ul><li>For **starts with**, **is**, **is like**, and **ends with**, type the value you want. You can use [supported characters](#supported-characters).</li><li>For **list**, specify a list of slug. Only the products whose slugs you have specified are shown.</li></ul> |
...
| UPC/EAN | <ul><li>**starts with**</li><li>**is**</li><li>**is like**</li><li>**ends with**</li><li>**list**</li> | <ul><li>For **starts with**, **is**, **is like**, and **ends with**, type the value you want. You can use [supported characters](#supported-characters).</li><li>For **list**, specify a list of UPC/EANs. Only the products whose UPC/EANs you have specified are shown.</li></ul> |
