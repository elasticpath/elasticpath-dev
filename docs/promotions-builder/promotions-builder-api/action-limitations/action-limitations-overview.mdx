...
They can be combined with action conditions to create specific rules for the promotion. For more information, see [Create an Item Discount with Condition](/docs/promotions-builder/promotions-builder-api/item-level-promotions/create-item-discount-with-condition).
...
These limitations can be combined and applied separately according to your business requirements. See [Create Action Limitations](/docs/promotions-builder/promotions-builder-api/action-limitations/create-limitations-and-exclusion-rule-promotion).
