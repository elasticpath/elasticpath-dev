...
| `rule_set.actions.limitations` | `object` | Optional | Defines how limitiations are applied to promotions. These limitations dictate how the promotion can be used and what criteria must be met for it to be applied. For more information, see [Action Limitations](/docs/rule-promotions/rule-promotions-api/action-limitations/action-limitations-overview). |
