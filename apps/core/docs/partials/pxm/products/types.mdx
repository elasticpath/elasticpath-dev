...
* `parent` - A parent product is a product that has child products that have been built in Commerce Manager or using the [**Build Child Products**](/docs/api/pxm/products/build-child-products) endpoint.
