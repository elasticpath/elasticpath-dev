...
<TabItem value="npm" title="npm" default>
...
For further explanation see [Authentication](/docs/developer-tools/composable-cli/installation#authentication).
...
Select the store you want to use for your storefront. If you've already selected a store you will see the "Using store" info message that tells you what store is active. You can switch store by calling the `ep store set` command [learn more here](/docs/developer-tools/composable-cli/commands#command-reference)
...
<TabItem title="npm" value={"npm"} default>
...
Lean how to deploy your storefront to production [here](/docs/developer-tools/composable-starter/deploy/storefront-deploy).
