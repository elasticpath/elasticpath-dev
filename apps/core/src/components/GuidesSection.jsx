...
export default function GuidesSection({ title, className }) {
  return (
    <Section title={title} className={className}>
      <Card
        title="Elastic Path Embed"
        description="Embed an SDK easily"
        to="/guides/embed"
      />
      <Card
      ...
      <Card
        ...
        description="Elastic Path allows livestreaming, via RTMP as well as HLS, for all Elastic Path meetings."
        to="/guides/integrating-with-webhooks"
      />
      <Card
