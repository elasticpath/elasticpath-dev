...
Your team members can be assigned [roles](/self-managed/composer/builder/users.mdx#organization-team-member-roles), so your DevOps team members might have administrator access, while your support team might have permission to review integration logs.
...
To update your organization's name programmatically, use the [updateOrganization](/self-managed/composer/builder/api/schema/mutation/updateOrganization.mdx) mutation:
...
After creating your organization, you can create [accounts](/self-managed/composer/builder/users.mdx#organization-users) for your team members so that they can create and maintain integrations for your customers.
...
Select an appropriate [role](/self-managed/composer/builder/users.mdx#organization-team-member-roles) for your team member, and enter their name and email address.
...
**For More Information**: [Users](/self-managed/composer/builder/users.mdx)
...
An [alert group](/self-managed/composer/builder/monitoring-and-alerting.mdx#alert-groups) is a set of users to notify and webhooks to invoke when an [alert trigger](/self-managed/composer/builder/monitoring-and-alerting.mdx#alert-triggers) fires.
...
**For More Information**: [Monitoring and Alerting](/self-managed/composer/builder/monitoring-and-alerting.mdx)
...
See the [Embedding Marketplace](/self-managed/composer/builder/embedding-marketplace.mdx#theming-embedded-marketplace) article for information on custom theming.
