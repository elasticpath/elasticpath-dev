...
If your integration is made up of multiple [flows](/self-managed/composer/builder/building-integrations.mdx#flows-in-integrations), each flow is tested independently.
...
If you specified default values for your [config variables](/self-managed/composer/builder/building-integrations.mdx#config-variables-in-integrations), those will be preset for you.
...
:::tip Time-saving tip
Just like [instance replays](/self-managed/composer/builder/instances.mdx#instance-execution-retry-and-replay), you can replay a test integration invocation.
