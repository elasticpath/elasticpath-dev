...
For example, the [SFTP component](/self-managed/composer/builder/builder-components/sftp.mdx) allows integrations to download and modify files on an SFTP server.
The [Slack component](/self-managed/composer/builder/builder-components/slack.mdx) posts messages to Slack channels.

Several components are strung together to form an [integration](/self-managed/composer/builder/integrations.mdx).
...
Builder offers a wide array of components to accomplish a variety of things, like serializing data formats, invoking REST endpoints, or interacting with commonly-used SaaS platforms like AWS, Slack, or Dropbox - see our [component catalog](/self-managed/composer/builder/builder-components/component-catalog.mdx) for a full list of components.
...
You can deploy your own code in the form of reusable [custom components](/self-managed/composer/builder/custom-components/code-vs-custom-components.mdx) or short [code component](/self-managed/composer/builder/builder-components/code.mdx) steps.

**For More Information**:
[When Should I Use a Custom Component vs a Code Component?](/self-managed/composer/builder/custom-components/code-vs-custom-components.mdx#when-should-i-use-a-custom-component-vs-a-code-component)

## Component actions

Components contain one or more **actions** that can be invoked.
For example, the [Amazon S3 component](/self-managed/composer/builder/builder-components/aws-s3.mdx) contains actions to copy S3 objects, delete objects, get an object's contents, etc.
...
**For More Information**:
[Custom Component Actions](/self-managed/composer/builder/custom-components/writing-custom-components.mdx#writing-actions)
...
**For More Information**:
[Choosing Component Versions](/self-managed/composer/builder/building-integrations.mdx#choosing-component-versions)
