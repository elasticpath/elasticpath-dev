...
In this step you'll prepare the [integration you created](/self-managed/composer/builder/getting-started/first-integration/build-first-integration.mdx) for the [integration marketplace](/self-managed/composer/builder/integration-marketplace.mdx).
Once the integration has been added to your integration marketplace, your customers can activate it for themselves.
The can do that by logging in to Builder using [customer users](/self-managed/composer/builder/users.mdx#customer-users), or if you [embed the marketplace](/self-managed/composer/builder/embedding-marketplace.mdx) in your app, they can activate the integration without leaving your app.
...
Now, you can either [add customer users](/self-managed/composer/builder/users.mdx#customer-users) to Builder and let them activate this integration, or you can [embed marketplace](/self-managed/composer/builder/embedding-marketplace.mdx) in your own app so users can seamlessly activate integrations without having to leave your app.
...
- Modify your integration to use [additional components](/self-managed/composer/builder/builder-components/component-catalog.mdx).
- Write [your own component](/self-managed/composer/builder/custom-components/code-vs-custom-components.mdx) to accomplish industry-specific business logic for your company.
