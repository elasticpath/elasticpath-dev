...
The code component, alongside [custom components](/self-managed/composer/builder/custom-components/writing-custom-components.mdx), allows you to write the product- or industry-specific portions of your integration that aren't readily solved using built-in components from the [component catalog](/self-managed/composer/builder/builder-components/component-catalog.mdx).
...
If you need to run the same code for multiple integrations, if your code is complex enough that it would benefit from unit testing, or if you are reliant on lots of external Node.JS libraries, consider creating a [custom component](/self-managed/composer/builder/custom-components/writing-custom-components.mdx) instead.
