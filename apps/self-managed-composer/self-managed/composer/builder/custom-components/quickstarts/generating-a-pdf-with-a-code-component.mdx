...
Adding this `require()` line to the top of our code component will cause the code component to [dynamically import](/self-managed/composer/builder/code-component-usage.mdx#adding-dependencies-to-a-code-step) the PDF-LIB library as a dependency.
...
For more information on code components checkout the [code component usage](/self-managed/composer/builder/code-component-usage.mdx) page.
