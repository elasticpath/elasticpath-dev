...
A full list of runner limits can be found [here](/self-managed/composer/builder/integration-runner-environment-limits.mdx).
...
To upload a file directly to your customer's Amazon S3 bucket, you can use the [Generate Presigned URL](/self-managed/composer/builder/builder-components/aws-s3.mdx#generate-presigned-url) action from the Amazon S3 component.
...
Similar to presigned URLs for Amazon S3, you can use the [Generate Temporary Upload Link](/self-managed/composer/builder/builder-components/dropbox.mdx#generate-temporary-upload-link) action from the Dropbox component to upload a file directly to Dropbox.
...
For more information on query the Composer API, see the [Composer API documentation](/self-managed/composer/builder/api/api-overview.mdx).

## Instruct Dropbox to download a file from a URL

If you have a file that is publically available at a certain URL, you can use the [Save from URL](/self-managed/composer/builder/builder-components/dropbox.mdx#save-from-url) action from the Dropbox component to instruct Dropbox to download the file from the internet.
