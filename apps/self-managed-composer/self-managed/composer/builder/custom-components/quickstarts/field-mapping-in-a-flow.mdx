...
If you've already built a [custom field mapper](/self-managed/composer/builder/custom-components/quickstarts/field-mapping-json-forms-datasource.mdx), the next step is to use the results of that field mapper to map data in a flow.
