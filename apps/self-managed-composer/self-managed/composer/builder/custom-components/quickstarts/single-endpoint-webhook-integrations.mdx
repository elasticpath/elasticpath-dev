...
You can [import](/self-managed/composer/builder/integrations.mdx#importing-an-integration) the integrations for yourself and extend them however you see fit.
