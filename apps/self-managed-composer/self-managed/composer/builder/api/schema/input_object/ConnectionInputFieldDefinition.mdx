...
| `shown`               | [`Boolean`](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx)                           | Whether or not the field is shown to Integrators and Deployers. Field must have a default is this is `false`. |
| `onPremiseControlled` | [`Boolean`](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx)                           | Whether or not the field is controlled by the attached On-Premise Resource.                                   |
