...
## Input fields ([ChangePasswordInput!](/self-managed/composer/builder/api/schema/input_object/ChangePasswordInput.mdx))

| Argument           | Type                                      | Description                                                 |
| ------------------ | ----------------------------------------- | ----------------------------------------------------------- |
| `currentPassword`  | [`String!`](/self-managed/composer/builder/api/schema/scalar/String.mdx) | The current password.                                       |
| `newPassword`      | [`String!`](/self-managed/composer/builder/api/schema/scalar/String.mdx) | The new password.                                           |
...
## Return fields ([ChangePasswordPayload](/self-managed/composer/builder/api/schema/object/ChangePasswordPayload.mdx))
