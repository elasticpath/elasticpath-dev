...
## Input fields ([DeleteUserInput!](/self-managed/composer/builder/api/schema/input_object/DeleteUserInput.mdx))
...
## Return fields ([DeleteUserPayload](/self-managed/composer/builder/api/schema/object/DeleteUserPayload.mdx))
