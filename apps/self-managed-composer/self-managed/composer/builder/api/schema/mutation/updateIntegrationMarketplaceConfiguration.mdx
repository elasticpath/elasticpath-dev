...
## Input fields ([UpdateIntegrationMarketplaceConfigurationInput!](/self-managed/composer/builder/api/schema/input_object/UpdateIntegrationMarketplaceConfigurationInput.mdx))
...
## Return fields ([UpdateIntegrationMarketplaceConfigurationPayload](/self-managed/composer/builder/api/schema/object/UpdateIntegrationMarketplaceConfigurationPayload.mdx))
