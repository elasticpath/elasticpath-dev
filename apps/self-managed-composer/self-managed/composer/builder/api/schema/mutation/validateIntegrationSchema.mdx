...
## Input fields ([ValidateIntegrationSchemaInput!](/self-managed/composer/builder/api/schema/input_object/ValidateIntegrationSchemaInput.mdx))
...
## Return fields ([ValidateIntegrationSchemaPayload](/self-managed/composer/builder/api/schema/object/ValidateIntegrationSchemaPayload.mdx))
