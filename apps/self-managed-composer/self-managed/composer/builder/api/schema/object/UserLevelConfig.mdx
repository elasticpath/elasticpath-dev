...
###### <b>configVariables</b> ([UserLevelConfigVariableConnection!](/self-managed/composer/builder/api/schema/object/UserLevelConfigVariableConnection.mdx))
...
###### <b>flowConfigs</b> ([UserLevelFlowConfigConnection!](/self-managed/composer/builder/api/schema/object/UserLevelFlowConfigConnection.mdx))
