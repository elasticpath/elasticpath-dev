...
###### <b>config</b> ([UserLevelConfig!](/self-managed/composer/builder/api/schema/object/UserLevelConfig.mdx))
...
###### <b>scheduleType</b> ([UserLevelConfigVariableScheduleType](/self-managed/composer/builder/api/schema/enum/UserLevelConfigVariableScheduleType.mdx))

The schedule type to show in the UI when the Config Var uses the 'schedule' dataType.

###### <b>status</b> ([UserLevelConfigVariableStatus](/self-managed/composer/builder/api/schema/enum/UserLevelConfigVariableStatus.mdx))
