...
###### <b>endpointSecurityType</b> ([IntegrationFlowEndpointSecurityType!](/self-managed/composer/builder/api/schema/enum/IntegrationFlowEndpointSecurityType.mdx))
...
###### <b>isSynchronous</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))
...
###### <b>organizationApiKeys</b> ([[String]](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The API key(s) to use for the endpoint of this IntegrationFlow when the endpoint security type is 'organization'.

###### <b>retryDelayMinutes</b> ([Int!](/self-managed/composer/builder/api/schema/scalar/Int.mdx))

Specifies the delay in minutes between retry attempts of Executions of this IntegrationFlow.

###### <b>retryMaxAttempts</b> ([Int!](/self-managed/composer/builder/api/schema/scalar/Int.mdx))

Specifies the maximum number of retry attempts that will be performed for Executions of this IntegrationFlow.

###### <b>retryUniqueRequestIdField</b> ([Expression](/self-managed/composer/builder/api/schema/object/Expression.mdx))

Specifies a reference to the data to use as a Unique Request ID for retry request cancellation.

###### <b>retryUsesExponentialBackoff</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))
...
###### <b>testContentType</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

Content type of the payload for testing this Integration Flow.

###### <b>testExecutionResults</b> ([InstanceExecutionResultConnection!](/self-managed/composer/builder/api/schema/object/InstanceExecutionResultConnection.mdx))

The Execution Results that were generated during testing.

###### <b>testHeaders</b> ([JSONString](/self-managed/composer/builder/api/schema/scalar/JSONString.mdx))

Headers of the request for testing this Integration Flow.

###### <b>testPayload</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

Data payload for testing this Integration Flow.

###### <b>testUrl</b> ([String!](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The URL of the endpoint that triggers execution of the Integration Flow in the Test Runner.

###### <b>trigger</b> ([IntegrationAction!](/self-managed/composer/builder/api/schema/object/IntegrationAction.mdx))
