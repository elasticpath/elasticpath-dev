...
###### <b>errorHandlerType</b> ([IntegrationActionErrorHandlerType](/self-managed/composer/builder/api/schema/enum/IntegrationActionErrorHandlerType.mdx))
...
###### <b>retryDelaySeconds</b> ([Int](/self-managed/composer/builder/api/schema/scalar/Int.mdx))

Specifies the delay in seconds between retry attempts for failures of this IntegrationAction.

###### <b>retryIgnoreFinalError</b> ([Boolean](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))
