...
###### <b>type</b> ([ThemePropertyType!](/self-managed/composer/builder/api/schema/enum/ThemePropertyType.mdx))
...
###### <b>variant</b> ([ThemePropertyVariant](/self-managed/composer/builder/api/schema/enum/ThemePropertyVariant.mdx))
