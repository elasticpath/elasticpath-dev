...
| -------- | --------------------------------- | ------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the Log object. |

## Return fields ([Log](/self-managed/composer/builder/api/schema/object/Log.mdx))
...
###### <b>configVariable</b> ([InstanceConfigVariable](/self-managed/composer/builder/api/schema/object/InstanceConfigVariable.mdx))
...
###### <b>customerName</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The name of the Customer that is associated with the Log entry.

###### <b>executionResult</b> ([InstanceExecutionResult](/self-managed/composer/builder/api/schema/object/InstanceExecutionResult.mdx))
...
###### <b>flowName</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The name of the IntegrationFlow that is associated with the Log entry.

###### <b>fromPreprocessFlow</b> ([Boolean](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))
...
###### <b>instanceId</b> ([ID](/self-managed/composer/builder/api/schema/scalar/ID.mdx))

The ID of the Instance which created the Log entry.

###### <b>instanceName</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))
...
###### <b>integrationName</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The name of the Integration that is associated with the Log entry.

###### <b>integrationVersionSequenceId</b> ([UUID](/self-managed/composer/builder/api/schema/scalar/UUID.mdx))
...
###### <b>loopStepIndex</b> ([Int](/self-managed/composer/builder/api/schema/scalar/Int.mdx))

The iteration index of the containing Loop IntegrationAction at the time this Log entry was generated, if any.

###### <b>loopStepName</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The name of the IntegrationAction that is the Loop containing the IntegrationAction that generated this Log entry, if any.

###### <b>message</b> ([String!](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The message body of the Log entry.

###### <b>requiredConfigVariableKey</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The key of the Required Config Variable which relates to the Log entry.

###### <b>severity</b> ([LogSeverityLevel!](/self-managed/composer/builder/api/schema/enum/LogSeverityLevel.mdx))

The severity level of the Log entry.

###### <b>stepName</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))
