...
| -------- | --------------------------------- | --------------------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the OnPremiseResource object. |

## Return fields ([OnPremiseResource](/self-managed/composer/builder/api/schema/object/OnPremiseResource.mdx))
...
###### <b>port</b> ([Int!](/self-managed/composer/builder/api/schema/scalar/Int.mdx))

The local port on the proxy service assigned to this resource.

###### <b>status</b> ([OnPremiseResourceStatus!](/self-managed/composer/builder/api/schema/enum/OnPremiseResourceStatus.mdx))
