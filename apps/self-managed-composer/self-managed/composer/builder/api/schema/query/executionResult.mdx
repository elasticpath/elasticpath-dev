...
| -------- | --------------------------------- | --------------------------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the InstanceExecutionResult object. |

## Return fields ([InstanceExecutionResult](/self-managed/composer/builder/api/schema/object/InstanceExecutionResult.mdx))
