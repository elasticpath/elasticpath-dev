...
| -------- | --------------------------------- | -------------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the AlertEvent object. |

## Return fields ([AlertEvent](/self-managed/composer/builder/api/schema/object/AlertEvent.mdx))
...
###### <b>details</b> ([String!](/self-managed/composer/builder/api/schema/scalar/String.mdx))
...
###### <b>monitor</b> ([AlertMonitor!](/self-managed/composer/builder/api/schema/object/AlertMonitor.mdx))
