...
| -------- | --------------------------------- | -------------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the AlertGroup object. |

## Return fields ([AlertGroup](/self-managed/composer/builder/api/schema/object/AlertGroup.mdx))
