...
| -------- | --------------------------------- | ------------------------------ |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the Activity object. |

## Return fields ([Activity](/self-managed/composer/builder/api/schema/object/Activity.mdx))
