...
| -------- | --------------------------------- | --------------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the Integration object. |

## Return fields ([Integration](/self-managed/composer/builder/api/schema/object/Integration.mdx))

###### <b>actions</b> ([IntegrationActionConnection!](/self-managed/composer/builder/api/schema/object/IntegrationActionConnection.mdx))

The Integration to which the IntegrationAction is associated via the IntegrationFlow.

###### <b>allowFork</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))
...
###### <b>allowMultipleMarketplaceInstances</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))

Specifies whether multiple Instances of this Integration may be created from the Marketplace.

###### <b>allowPublish</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))
...
###### <b>category</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))
...
###### <b>configPages</b> ([JSONString!](/self-managed/composer/builder/api/schema/scalar/JSONString.mdx))
...
###### <b>definition</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))
...
###### <b>documentation</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

Rich text documentation to accompany the Integration.

###### <b>endpointConfigTestContentType</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

Content type of the payload for testing the endpoint configuration for this Integration.

###### <b>endpointConfigTestHeaders</b> ([JSONString](/self-managed/composer/builder/api/schema/scalar/JSONString.mdx))
...
###### <b>endpointConfigTestPayload</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

Data payload for testing the endpoint configuration for this Integration.

###### <b>endpointConfigTestUrl</b> ([String!](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The URL of the endpoint that allows testing the endpoint configuration of the Integration.

###### <b>endpointType</b> ([IntegrationEndpointType](/self-managed/composer/builder/api/schema/enum/IntegrationEndpointType.mdx))
...
###### <b>externalVersion</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

Specifies the external version of this Integration, which can be used to provide semantic versioning.

###### <b>flows</b> ([IntegrationFlowConnection!](/self-managed/composer/builder/api/schema/object/IntegrationFlowConnection.mdx))

The Integration of which the IntegrationFlow is a part.

###### <b>hasOutdatedComponents</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))

Specifies whether the Integration uses outdated Components

###### <b>hasUnpublishedChanges</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))
...
###### <b>isCodeNative</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))
...
###### <b>marketplaceConfiguration</b> ([MarketplaceConfiguration!](/self-managed/composer/builder/api/schema/enum/MarketplaceConfiguration.mdx))
...
###### <b>marketplaceTabConfiguration</b> ([[String!]](/self-managed/composer/builder/api/schema/scalar/String.mdx))
...
###### <b>overview</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

Specifies an Overview of the Integration to describe its functionality for use in the Integration Marketplace.

###### <b>parent</b> ([Integration](/self-managed/composer/builder/api/schema/object/Integration.mdx))

Parent Integration this Integration was forked from, if any

###### <b>preprocessFlowName</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

The name of a Flow in the Integration that will be executed as a preprocessing step prior to any other Flow executions.

###### <b>requiredConfigVariables</b> ([RequiredConfigVariableConnection!](/self-managed/composer/builder/api/schema/object/RequiredConfigVariableConnection.mdx))
...
###### <b>storeConfiguration</b> ([IntegrationStoreConfiguration](/self-managed/composer/builder/api/schema/enum/IntegrationStoreConfiguration.mdx))
...
###### <b>systemInstance</b> ([Instance!](/self-managed/composer/builder/api/schema/object/Instance.mdx))

System Instance backing this Integration.

###### <b>templateConfiguration</b> ([IntegrationTemplateConfiguration!](/self-managed/composer/builder/api/schema/enum/IntegrationTemplateConfiguration.mdx))

Specifies whether the latest published version of this Integration may be used as a template to create new Integrations.

###### <b>testConfigVariables</b> ([InstanceConfigVariableConnection!](/self-managed/composer/builder/api/schema/object/InstanceConfigVariableConnection.mdx))
...
###### <b>useAsTemplate</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))
...
###### <b>versionAt</b> ([Integration](/self-managed/composer/builder/api/schema/object/Integration.mdx))

Object data at specified version

###### <b>versionComment</b> ([String](/self-managed/composer/builder/api/schema/scalar/String.mdx))

Additional comments about this version.

###### <b>versionCreatedAt</b> ([DateTime](/self-managed/composer/builder/api/schema/scalar/DateTime.mdx))

Timestamp of the creation of this version.

###### <b>versionCreatedBy</b> ([User](/self-managed/composer/builder/api/schema/object/User.mdx))

User that created this version.

###### <b>versionIsAvailable</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))

Indicates if the version is available for use.

###### <b>versionIsLatest</b> ([Boolean!](/self-managed/composer/builder/api/schema/scalar/Boolean.mdx))

Marked if this record is the latest version of this sequence.

###### <b>versionNumber</b> ([Int!](/self-managed/composer/builder/api/schema/scalar/Int.mdx))

Sequential number identifying this version.

###### <b>versionSequence</b> ([IntegrationConnection!](/self-managed/composer/builder/api/schema/object/IntegrationConnection.mdx))

Sequence of versions of this Integration

###### <b>versionSequenceId</b> ([UUID](/self-managed/composer/builder/api/schema/scalar/UUID.mdx))

Identifier for this version sequence.

###### <b>versions</b> ([VersionConnection!](/self-managed/composer/builder/api/schema/object/VersionConnection.mdx))
