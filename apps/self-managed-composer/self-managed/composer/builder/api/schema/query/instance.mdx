...
| -------- | --------------------------------- | ------------------------------ |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the Instance object. |

## Return fields ([Instance](/self-managed/composer/builder/api/schema/object/Instance.mdx))
