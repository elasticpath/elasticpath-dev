...
| -------- | --------------------------------- | ----------------------------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the InstanceDailyUsageMetrics object. |

## Return fields ([InstanceDailyUsageMetrics](/self-managed/composer/builder/api/schema/object/InstanceDailyUsageMetrics.mdx))
