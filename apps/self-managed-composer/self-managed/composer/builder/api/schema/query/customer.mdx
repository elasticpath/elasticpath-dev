...
| -------- | --------------------------------- | ------------------------------ |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the Customer object. |

## Return fields ([Customer](/self-managed/composer/builder/api/schema/object/Customer.mdx))
