...
| -------- | --------------------------------- | ---------------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the AlertWebhook object. |

## Return fields ([AlertWebhook](/self-managed/composer/builder/api/schema/object/AlertWebhook.mdx))
