...
| -------- | --------------------------------- | ----------------------------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the CustomerTotalUsageMetrics object. |

## Return fields ([CustomerTotalUsageMetrics](/self-managed/composer/builder/api/schema/object/CustomerTotalUsageMetrics.mdx))
