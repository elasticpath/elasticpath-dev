...
| -------- | --------------------------------- | ---------------------------------------- |
| `id`     | [`ID!`](/self-managed/composer/builder/api/schema/scalar/ID.mdx) | The ID of the InstanceFlowConfig object. |

## Return fields ([InstanceFlowConfig](/self-managed/composer/builder/api/schema/object/InstanceFlowConfig.mdx))
...
###### <b>apiKeys</b> ([[String]](/self-managed/composer/builder/api/schema/scalar/String.mdx))
