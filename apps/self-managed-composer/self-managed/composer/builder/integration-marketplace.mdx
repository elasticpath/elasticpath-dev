...
You can [embed](/self-managed/composer/builder/embedding-marketplace.mdx) marketplace within your app so your users can seamlessly deploy integrations natively using your existing authentication system.
...
Customers follow a simple configuration and deployment experience that [you create](/self-managed/composer/builder/building-integrations.mdx#config-variables-in-integrations) when you build the integration - they enter some configuration values and credentials, select a few options from some dropdown menus, and click "activate".
...
1. You can [embed the integration marketplace](/self-managed/composer/builder/embedding-marketplace.mdx) within your app as an iframe.
   This option allows your customers to activate integrations natively within your app.
   You can [theme](/self-managed/composer/builder/embedding-marketplace.mdx#theming-embedded-marketplace) the integration marketplace to match your app's branding.
...
2. For a fully native expeirence, you can use the [embedded SDK](/self-managed/composer/builder/installing-embedded.mdx) to [query Builder's API](/self-managed/composer/builder/embedded-api-requests.mdx) for information on integrations.
...
1. First, [publish your integration](/self-managed/composer/builder/integrations.mdx#publishing-an-integration) from the integration designer.
...
To make your integration look attractive in the integration marketplace, you can [add an icon](/self-managed/composer/builder/integrations.mdx#assigning-an-icon-to-an-integration) to your integration.
:::

### Preparing the configuration experience

Integrations are driven by [config variables](/self-managed/composer/builder/building-integrations.mdx/#config-variables-in-integrations).
...
Most organizations choose to [embed](/self-managed/composer/builder/embedding-marketplace.mdx) marketplace in their apps so integration activation is a seamless experience and their users never have to leave their app.

The instructions below apply if you're choosing _not_ to embed marketplace in your app.
You have the option to create [customer users](/self-managed/composer/builder/users.mdx#customer-users) in Builder, allowing your customers to log in to Builder and activate integrations for themselves.
:::
...
As an organization user, you can modify an integration that a customer activated as you would any other deployed [instance](/self-managed/composer/builder/instances.mdx#configuring-instances).
...
See our [Embedding Marketplace](/self-managed/composer/builder/embedding-marketplace.mdx) article for more details.
