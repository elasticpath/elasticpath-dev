...
| -------- | --------------------------------- | ------------------------------- |
| `id`     | [`ID!`](/composer/builder/api/schema/scalar/ID.mdx) | The ID of the Component object. |

## Return fields ([Component](/composer/builder/api/schema/object/Component.mdx))
