...
| -------- | --------------------------------- | ------------------------------------------ |
| `id`     | [`ID!`](/composer/builder/api/schema/scalar/ID.mdx) | The ID of the OrgDailyUsageMetrics object. |

## Return fields ([OrgDailyUsageMetrics](/composer/builder/api/schema/object/OrgDailyUsageMetrics.mdx))
