...
| -------- | --------------------------------- | ---------------------------------- |
| `id`     | [`ID!`](/composer/builder/api/schema/scalar/ID.mdx) | The ID of the AlertMonitor object. |

## Return fields ([AlertMonitor](/composer/builder/api/schema/object/AlertMonitor.mdx))
