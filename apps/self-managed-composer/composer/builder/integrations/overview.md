...
Triggers can either follow a [schedule](/composer/builder/integrations/integrations-triggers/how-to-use-integration-triggers#scheduled-triggers), or can be invoked via a [webhook URL](/composer/builder/integrations/integrations-triggers/how-to-use-integration-triggers#webhook-triggers).
...
That is accomplished by leveraging [config variables](/composer/builder/integrations/building-integrations#config-variable-inputs), and have configuring steps to reference those variables.
...
You can then enable the integration through the [Integration Hub](/composer/integration-hub/integrations-hub).

We recommend that you follow our [Getting Started](/composer/builder/getting-started/build-first-integration) tutorials to first acquaint yourself with integration development and deployment.
...
- You can start from an existing [template](/composer/builder/integrations/overview#integration-templates) that you or someone else created.
...
- [Building Integrations](/composer/builder/integrations/building-integrations)
- [Testing Integrations](/composer/builder/integrations/testing-integrations)
...
Integrations can be assigned icons, to make them more presentable in the [Integration Hub](/composer/integration-hub/integrations-hub).
...
Assigning each integration a category allows your team, as well as your customers in the [Integration Hub](/composer/integration-hub/integrations-hub) to view integrations sorted by category.
...
You can also enable your customers to deploy integrations themselves, using [Integration Hub](/composer/integration-hub/integrations-hub).
