...
### Prerequisites
 ...
 - Ensure that you have created a template for [price book](pathname:///docs/commerce-manager/product-experience-manager/pricebooks/pxm-pricebooks#creating-price-books), [hierarchies](pathname:///docs/commerce-manager/product-experience-manager/hierarchies/creating_hierarchies), [templates](pathname:///docs/commerce-manager/product-experience-manager/extending-products/templates#creating-templates), and [Variations](pathname:///docs/commerce-manager/product-experience-manager/variations#creating-variations) in Commerce Manager.
