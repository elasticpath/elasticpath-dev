...
1. In Commerce, create your [templates](pathname:///docs/commerce-manager/product-experience-manager/extending-products/templates). Any Onport product attributes should have corresponding attributes in your Commerce templates.
