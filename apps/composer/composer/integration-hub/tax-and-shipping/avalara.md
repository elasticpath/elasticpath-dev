...
1. Enter the following details in **Commerce Connection**:
    ...
    **Token URL** for:
    ...
    To collect your **Client-ID** and **Client-Secret**, log into Commerce Manager with Seller Admin privileges and go to **SYSTEM** > **Application Keys**. See [Application Keys](pathname:///docs/commerce-manager/application-keys/application-keys-cm).
