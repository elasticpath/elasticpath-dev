...
###### <b>type</b> ([ThemePropertyType!](/composer/builder/api/schema/enum/ThemePropertyType.mdx))
...
###### <b>variant</b> ([ThemePropertyVariant](/composer/builder/api/schema/enum/ThemePropertyVariant.mdx))
