...
| -------- | --------------------------------- | ------------------------------------------- |
| `id`     | [`ID!`](/composer/builder/api/schema/scalar/ID.mdx) | The ID of the ObjectPermissionGrant object. |

## Return fields ([ObjectPermissionGrant](/composer/builder/api/schema/object/ObjectPermissionGrant.mdx))
...
###### <b>grantedByRole</b> ([Role](/composer/builder/api/schema/object/Role.mdx))
...
###### <b>obj</b> ([UUID!](/composer/builder/api/schema/scalar/UUID.mdx))

A reference to the object for which the Permission is granted.

###### <b>permission</b> ([Permission!](/composer/builder/api/schema/object/Permission.mdx))
