...
| -------- | --------------------------------- | ------------------------------------ |
| `id`     | [`ID!`](/composer/builder/api/schema/scalar/ID.mdx) | The ID of the AuthObjectType object. |

## Return fields ([AuthObjectType](/composer/builder/api/schema/object/AuthObjectType.mdx))
