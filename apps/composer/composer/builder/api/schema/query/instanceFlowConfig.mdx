...
| -------- | --------------------------------- | ---------------------------------------- |
| `id`     | [`ID!`](/composer/builder/api/schema/scalar/ID.mdx) | The ID of the InstanceFlowConfig object. |

## Return fields ([InstanceFlowConfig](/composer/builder/api/schema/object/InstanceFlowConfig.mdx))
