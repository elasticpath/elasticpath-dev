...
const PRODUCTS = [
    ...
    },
    {
        ...
        link: '/guides/How-To/Subscriptions/getting-started/merchandizer-getting-started/managing-subscriptions',
        icon: Guide,
...
export default function SubsHeroSection() {
    return (
        <>
            ...
            <section className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-6 px-4 md:grid-cols-3 py-16">
                {PRODUCTS.map((product) => (
                    <SubsHero {...product} key={product.title} />
                ))}
            </section>
        </>
    );
