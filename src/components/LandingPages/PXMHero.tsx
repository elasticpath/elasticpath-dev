...
const PRODUCTS = [
    {
        ...
        text: 'View the documentation, download the specification files, learn more about the APIs.',
    },
    {
        ...
        text: 'Get step-by-step instructions for managing Product Experience Manager in our user interface.',
    },
    {
        title: 'Guides & Learning',
        link: '/guides/How-To/Products/get-started-pxm',
        icon: Guide,
...
export default function PXMHeroSection() {
    return (
        <>
            ...
            <section className="mx-auto grid w-full max-w-7xl grid-cols-1 gap-6 px-4 md:grid-cols-3 py-16">
                {PRODUCTS.map((product) => (
                    <PXMHero {...product} key={product.title} />
                ))}
            </section>
        </>
    );
