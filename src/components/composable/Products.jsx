...
const Products = () => {
  const capabilities = [
    ...
    { title: 'Payment Gateways', description: 'With nine out-of-the-box payment gateway providers and support for manual payment options, you have the freedom to tailor your setup and optimize your transaction flow. Seamlessly integrate your preferred providers and enjoy a streamlined checkout experience that drives conversions and enhances customer satisfaction.', cta: '' },
  ];
